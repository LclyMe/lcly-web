...
export const metadata: Metadata = {
  title: {
    default: "Lcly | Your UK Postcode Online",
    template: "%s | Lcly",
  },
  description:
    "Find your community, meet neighbours, and improve your local area. Or help up build app that real communities can actually use.",
  keywords: [
    "postcode",
    "community",
    "neighbours",
